  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
            ...
            Get started todan and turn your imagination into immersive reality!
        </p>
        ...
        <flex className="flex mt-10 justify-center">
            <video className="rounded-lg w-1/2 border border-orange-500 shadow-orange-400 mx-2 my-4" loop muted autoPlay={true}>
